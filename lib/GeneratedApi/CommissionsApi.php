...
class CommissionsApi
{
     ...
     * @return \Swagger\BolClient\Model\Commission
     */
     ...
     * @throws \Swagger\BolClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\BolClient\Model\Commission, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCommissionWithHttpInfo($ean, $unit_price, $condition = 'NEW')
    {
        $returnType = '\Swagger\BolClient\Model\Commission';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\BolClient\Model\Commission',
     ...
     */
    protected function getCommissionRequest($ean, $unit_price, $condition = 'NEW')
    {
        ...
        // query params
        if ($unit_price !== null) {
            $queryParams['unit-price'] = ObjectSerializer::toQueryValue($unit_price);
        }
     ...
     *
     * @param  \Swagger\BolClient\Model\BulkCommissionRequest $body body (optional)
     *
     * @throws \Swagger\BolClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\BolClient\Model\BulkCommissionResponse
     */
     ...
     * Get all commissions and reductions by EAN in bulk
     *
     * @param  \Swagger\BolClient\Model\BulkCommissionRequest $body (optional)
     *
     * @throws \Swagger\BolClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\BolClient\Model\BulkCommissionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCommissionsWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\BolClient\Model\BulkCommissionResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\BolClient\Model\BulkCommissionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCommissionsRequest($body = null)
    {
