...
class ProductContentApi
{
     ...
     * @return \Swagger\BolClient\Model\ValidationReportResponse
     */
     ...
     * @throws \Swagger\BolClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\BolClient\Model\ValidationReportResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getValidationReportWithHttpInfo($upload_id)
    {
        $returnType = '\Swagger\BolClient\Model\ValidationReportResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\BolClient\Model\ValidationReportResponse',
     ...
     */
    protected function getValidationReportRequest($upload_id)
    {
     ...
     *
     * @param  \Swagger\BolClient\Model\CreateProductContentRequest $body body (optional)
     *
     * @throws \Swagger\BolClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Post product content
     *
     * @param  \Swagger\BolClient\Model\CreateProductContentRequest $body (optional)
     *
     * @throws \Swagger\BolClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postProductContentRequest($body = null)
    {
