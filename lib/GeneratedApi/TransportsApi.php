...
class TransportsApi
{
     ...
     * @param  \Swagger\BolClient\Model\ChangeTransportRequest $body The change transport requested by the user. (optional)
     *
     ...
     */
    protected function addTransportInformationByTransportIdRequest($transport_id, $body = null)
    {
