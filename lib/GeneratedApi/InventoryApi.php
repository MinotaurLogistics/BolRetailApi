...
class InventoryApi
{
     ...
     * @return \Swagger\BolClient\Model\InventoryResponse
     */
     ...
     * @throws \Swagger\BolClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\BolClient\Model\InventoryResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInventoryWithHttpInfo($page = '1', $quantity = null, $stock = null, $state = null, $query = null)
    {
        $returnType = '\Swagger\BolClient\Model\InventoryResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\BolClient\Model\InventoryResponse',
